#!/usr/bin/env python3
"""Serve the isolated GL02 V3 material/structure review page.
...
REQUIREMENT_ID = "REQ-BF3D-R2T-ISOLATED-REVIEW-PREVIEW-20260720"
EXPECTED_REVIEW_SHA256 = (
    "7e4b3b95343103784500aba354a124262ecf593fe89a3f0aa98348692152574b"
)
EXPECTED_REVIEW_BYTES = 4_380_396
LOOPBACK_HOSTS = {"127.0.0.1", "localhost"}

WORKSPACE_ROOT = Path(__file__).resolve().parents[1]
FRONTEND_ROOT = WORKSPACE_ROOT / "高炉前端数据"
REVIEW_ASSET = FRONTEND_ROOT / "models" / "gl02_blast_furnace_review.v3.glb"

ROUTES = {
    "/bf3d_review.server.html": FRONTEND_ROOT / "bf3d_review.server.html",
    "/assets/bf3d-review-renderer.js": (
        FRONTEND_ROOT / "assets" / "bf3d-review-renderer.js"
    ),
    "/assets/bf3d-review-renderer.css": (
        FRONTEND_ROOT / "assets" / "bf3d-review-renderer.css"
    ),
    "/models/gl02_blast_furnace_review.v3.glb": REVIEW_ASSET,
...
def validate_contract() -> dict[str, object]:
    ...
    return {
        ...
        "document": "高炉前端数据/bf3d_review.server.html",
        "review_asset": {
            "path": "高炉前端数据/models/gl02_blast_furnace_review.v3.glb",
            "bytes": actual_bytes,
...
class ReviewRequestHandler(BaseHTTPRequestHandler):
    ...
    def _serve(self, *, send_body: bool) -> None:
        ...
        if pathname == "/":
            ...
            self.send_header("Location", "/bf3d_review.server.html")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="启动 GL02 V3 独立、只读、SHA 锁定的材质/结构审查页。",
    ...
    parser.add_argument(
        "--check-only",
        action="store_true",
        help="只核验 allow-list 与 review.v3 SHA，不启动服务。",
    )
    return parser
...
def main(argv: list[str] | None = None) -> int:
    ...
    ready = {
        **contract,
        ...
        "host": actual_host,
        "port": actual_port,
        "url": f"http://{actual_host}:{actual_port}/bf3d_review.server.html",
    }
