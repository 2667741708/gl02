...
const REPORT_PATH = path.join(
  STAGE_ROOT,
  "reports",
  "bf3d_review_v5_preview_report.json",
);
const HTML_PATH = path.join(FRONTEND_ROOT, "bf3d_review_v5.server.html");
...
const SERVER_PATH = path.join(ROOT, "tools", "serve_bf3d_review_v5.py");
