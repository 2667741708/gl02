"""Freeze response-format/source separation over the verified V40 closure."""
import ast
import hashlib
import json
...
TARGET = ROOT / '.codex_runtime/qa-routing-v41/candidate-r1'
MODULE = 'qa_task_plan.py'


def main():
    sha = lambda raw: hashlib.sha256(raw).hexdigest()
    evidence = json.loads((ROOT / 'tests/qa_regression/declared_input_scope_20260917.json').read_bytes())
    ...
    metadata = {'schema': 'bf.qa.private-response-style-candidate.v1', 'candidate': 'v41-r1',
      ...
      'inherited_v40_files_byte_identical': inherited, 'changed_module': MODULE,
