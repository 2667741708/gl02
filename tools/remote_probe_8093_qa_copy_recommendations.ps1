...
$OutputPath = 'C:\Users\Administrator\AppData\Local\Temp\bf_8093_qa_copy_recommendations_20260814\remote-state.json'
...
foreach ($Port in @(8094, 8768, 8770, 5432, 11434, 8892)) {
    $Protected[[string]$Port] = Get-ListenerPid $Port
}
$State = [ordered]@{
