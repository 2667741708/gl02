#!/usr/bin/env python3
"""Serve the isolated GL02 R2W material-readability review page.
...
ROUTES = {
    "/bf3d_review_r2w.server.html": FRONTEND_ROOT / "bf3d_review_r2w.server.html",
    "/assets/bf3d-review-renderer-r2w.js": (
        FRONTEND_ROOT / "assets" / "bf3d-review-renderer-r2w.js"
    ),
...
def validate_contract() -> dict[str, object]:
    ...
    return {
        ...
        "document": "高炉前端数据/bf3d_review_r2w.server.html",
        "review_asset": {
...
class ReviewRequestHandler(BaseHTTPRequestHandler):
    ...
    def _serve(self, *, send_body: bool) -> None:
        ...
        if pathname == "/":
            ...
            self.send_header("Location", "/bf3d_review_r2w.server.html")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="启动 GL02 R2W 独立、只读、SHA 锁定的材质可读性审查页。",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog=(
            "示例：\n"
            "  python tools/serve_bf3d_review_r2w.py --check-only\n"
            "  python tools/serve_bf3d_review_r2w.py --port 8125\n"
            "  python tools/serve_bf3d_review_r2w.py --port 0 --quiet\n\n"
...
def main(argv: list[str] | None = None) -> int:
    ...
    ready = {
        **contract,
        ...
        "host": actual_host,
        "port": actual_port,
        "url": f"http://{actual_host}:{actual_port}/bf3d_review_r2w.server.html",
    }
