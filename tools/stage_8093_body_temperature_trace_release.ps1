...
$Arguments = @(
    ...
    '--upload', "高炉前端数据\frontend_dashboard_v3.server.html=$Stage\frontend_dashboard_v3.server.html",
    ...
    '--upload', ".tmp\8093-body-temperature-trace-20260814\delta-plan.json=$Stage\delta-plan.json",
    ...
    '--upload', "tools\deploy_8093_body_temperature_trace_20260814.ps1=$Stage\run_deploy.ps1"
)
& $Python @Arguments
