...
$RequirementId = 'REQ-QA-NO-CODE-EVIDENCE-BASELINE-20260915'
$ExecutionId = 'qa-evidence-20260915-v2'
$CommitMessage = 'fix: preserve snapshot facts and constrain analysis [REQ-QA-NO-CODE-EVIDENCE-BASELINE-20260915] [qa-evidence-20260915-v2]'
$Root = 'F:\高炉炼铁项目-real-sensor-v2_V4_8093_PREVIEW'
$Git = 'C:\Program Files\Git\cmd\git.exe'
$Python = 'C:\Program Files\Python311\python.exe'
$MainRef = 'refs/heads/production-8093'
$StageRoot = 'C:/Users/Administrator/AppData/Local/Temp/qa-evidence-20260915-v2'
