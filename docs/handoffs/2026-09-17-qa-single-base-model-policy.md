...
状态：固定身份本机实现及候选已验证；禁切换管理器尚未安装，生产身份门未满足。当前路由候选以[V48来源授权交接](2026-09-17-qa-ordinary-context-source-gate.md)为准，共享生产变更保留见[V47集成](2026-09-17-qa-shared-proxy-integration.md)；下文V27/V26记录为历史阶段证据。
