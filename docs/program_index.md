...
[user_data_scope](../高炉前端数据/智能助手/backend/qa_task_plan.py:180)与live_query_text限定外部来源；[生成器](../tools/build_qa_user_data_scope_candidate.py:26)对实际冻结代理施加6处可逆接缝，13文件逐字节继承V38；alias、时窗、时钟、分析扩展和实体冻结均使用外部子任务。
