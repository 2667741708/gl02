...
- 状态：30 条合成用例已建立，另已执行 8 条真实线上基线；线上结果与夹具回归分开记录。
- 最后核对：2026-09-15。
...
8 条线上基线的观察结论见 [2026-09-15 基线记录](live_baseline_20260915.md)。这是小样本功能排障，不代表整体用户成功率；pass^5、并发稳定性与全部 30 条夹具的真实模型运行仍未测。所有越权、伪造实测、错误自动重放均应阻断，不能被平均分抵消。
